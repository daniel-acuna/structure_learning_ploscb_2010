function [Q] = StructureLearningModel(alpha1,beta1,alpha2,beta2,...
...
%         for hs1=H:-1:0
%           for hf1=H:-1:0
        new_pdfc_phi = StructureLearningModel_PosteriorCoupling(pdfc_phi, alpha1, beta1, alpha2, beta2, alpha3, beta3, s1+hs1, f1+hf1, s2+hs2, f2+hf2);        
        r1=StructureLearningModel_R(alpha1, beta1, alpha2, beta2, alpha3, beta3, new_pdfc_phi, s1+hs1, f1+hf1, s2+hs2, f2+hf2, 1);
        r2=StructureLearningModel_R(alpha1, beta1, alpha2, beta2, alpha3, beta3, new_pdfc_phi, s1+hs1, f1+hf1, s2+hs2, f2+hf2, 2);
        if (hs2+hf2+hs1+hf1>=H)
          V(hs2+1,hf2+1,hs1+1,hf1+1) = 0;%max(r1,r2);
        else
