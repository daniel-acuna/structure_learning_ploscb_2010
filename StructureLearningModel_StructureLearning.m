function [Q] = StructureLearningModel_StructureLearning(alpha1,beta1,alpha2,beta2,...
  ...
  for  hf2=(H-hs2):-1:0
    for hs1=(H-hf2-hs2):-1:0
      for hf1=(H-hs1-hf2-hs2):-1:0
        ...
        r1=StructureLearningModel_R(alpha1, beta1, alpha2, beta2, alpha3, beta3, new_pdfc_phi, s1, f1, s2, f2, 1);
        r2=StructureLearningModel_R(alpha1, beta1, alpha2, beta2, alpha3, beta3, new_pdfc_phi, s1, f1, s2, f2, 2);
